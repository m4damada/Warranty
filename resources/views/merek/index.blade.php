...
@section('menunya')
    <h1 class="font-weight-bold" style="font-size: 24px;">merek Mobil<h1>
@endsection
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Data merek Mobil</h4>
                    <!-- center modal -->
                    <div>
                        ...
                        <button type="button" class="btn btn-hblack mb-4" data-bs-toggle="modal" data-bs-target="#modalTambah"
                            style="margin-bottom: 1rem;"><i class="mdi mdi-plus me-1"></i>merek Mobil</button>
                    </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title">Tambah Merek Mobil</h5>
                                            ...
                                            <div class="row">
                                                <div class="col-xl-12">
                                                    ...
                                                    <input type="text" class="form-control" id="merek"
                                                        placeholder="Ketikkan merek mobil" name="merek" required>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            <a href="delete-merek/{{$x->id}}" class="btn btn-danger shadow btn-xs sharp btn-delete" data-name="{{$x->name}}"><i class="fa fa-trash"></i></a>
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="row">
                                                                        <div class="col-xl-12">
                                                                            ...
                                                                            <input type="text" class="form-control" id="merek"
                                                                                placeholder="Ketikkan merek mobil" name="name" required value="{{$x->name}}">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="modal-footer border-top-0 d-flex">
